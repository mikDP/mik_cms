                        ...
                        <div class='col-xs-12'>
                                ...
                                <div class='col-sm-12'>
                                    <div class='page-header'>
                                        <h1 class='pull-left'>
                                            ...
                                            <span>Modifica pagina menù associata a <b><?= $id_cat[2] ?>:</b></span>
                                        </h1>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2">
                                    ...
                                    <!--Inizio Form-->
                                    <form id="postForm" action="/mik_cms/controller/articolo_controller.php?menu=<?= $_GET['menu'] ?>&action=insert&cat=<?= $category; ?>&id=<?= $id; ?>&lan=<?= $id_lingua ?>" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label"for="home">Rendi Home:</label>
                                            <div class="col-sm-4">
                                                <input type="checkbox" class="checkbox"  data-id="home" name="home" id="home" value="1" <?php if($home == 1) echo "checked='checked'";?> >
                                            </div>
                                        </div>
                                        <br><br>
                                        <!--WYSIWYG tinyMCE-->  
